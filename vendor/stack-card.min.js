...
if (Util.hasClass = function(e, t) {
        ...
        e.children;
        for (var n = [], i = 0; i < e.children.length; i++) Util.hasClass(e.children[i], t) && n.push(e.children[i]);
        return n
        ...
        var o = t - e,
            ...
            l = function(t) {
                ...
                var a = t - r,
                    c = parseInt(a / i * o + e);
                n.style.height = c + "px", a < i ? window.requestAnimationFrame(l) : s()
            };
...
Math.easeInOutQuad = function(e, t, n, i) {
    ...
    function() {
        ...
        function t() {
            e.length > 0 && (i(!1), window.addEventListener("keydown", n)), window.removeEventListener("mousedown", t)
        }
    ...
    function() {
        var e = function(e) {
            this.element = e, this.items = this.element.getElementsByClassName("js-stack-cards__item"), this.scrollingFn = !1, this.scrolling = !1,
                function(e) {
                    i(e), new IntersectionObserver(t.bind(e), {
                        threshold: [0, 1]
                    }).observe(e.element)
                }(this),
                function(e) {
        ...
        function t(e) {
            if (e[0].isIntersecting) {
                ...
                (t = this).scrollingFn = n.bind(t), window.addEventListener("scroll", t.scrollingFn)
            } else {
                if (!this.scrollingFn) return;
        ...
        function n() {
            this.scrolling || (this.scrolling = !0, window.requestAnimationFrame(s.bind(this)))
        }
        ...
        function i(e) {
            e.marginY = getComputedStyle(e.element).getPropertyValue("--stack-cards-gap"),
                function(e) {
                    ...
                    t.setAttribute("style", "opacity:0; visbility: hidden;position: absolute; height:" + e.marginY), e.element.appendChild(t), e.marginY = parseInt(getComputedStyle(t).getPropertyValue("height")), e.element.removeChild(t)
                }(e), e.elementHeight = e.element.offsetHeight;
            var t = getComputedStyle(e.items[0]);
            e.cardTop = Math.floor(parseFloat(t.getPropertyValue("top"))), e.cardHeight = Math.floor(parseFloat(t.getPropertyValue("height"))), e.windowHeight = window.innerHeight, isNaN(e.marginY) ? e.element.style.paddingBottom = "0px" : e.element.style.paddingBottom = e.marginY * (e.items.length - 1) + "px";
            for (var n = 0; n < e.items.length; n++) isNaN(e.marginY) ? e.items[n].style.transform = "none;" : e.items[n].style.transform = "translateY(" + e.marginY * n + "px)"
        }
        ...
        function s() {
            if (isNaN(this.marginY)) this.scrolling = !1;
                ...
                if (this.cardTop - e + this.element.windowHeight - this.elementHeight - this.cardHeight + this.marginY + this.marginY * this.items.length > 0) this.scrolling = !1;
                else {
                    for (var t = 0; t < this.items.length; t++) {
                        ...
                        } else this.items[t].style.transform = "translateY(" + this.marginY * t + "px)"
                    }
                    this.scrolling = !1
                }
            }
        ...
        if (o.length > 0 && r && !l) {
            for (var a = [], c = 0; c < o.length; c++)(function(t) {
                a.push(new e(o[t]))
            })(c);
            var d = !1,
