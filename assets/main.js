...
class ModalAnimation {
    ...
    bindScrollTrigger() {
        ...
        window.addEventListener("scroll", tryTrigger, {
            passive: true
        });
        if (document.readyState === "complete" || document.readyState === "interactive") {
            tryTrigger();
        } else {
            document.addEventListener("DOMContentLoaded", tryTrigger, {
                once: true
            });
        }
    }
...
const svgDraw = {
    init() {
        ...
        gsap.set(existingSelectors.join(", "), {
            visibility: "visible"
        });
    ...
    init(root = document) {
        ...
        buttonWrappers.forEach((buttonWrapper) => {
            ...
            const calculateDistance = () => {
                ...
                return {
                    iconTranslateXDistance,
                    textTranslateXDistance
                };
            };
            const onEnter = () => {
                const {
...
const themeSwitcher = {
    ...
    setInitialTheme() {
        if (this.isForcedPage) {
            this.setTheme(this.forcedTheme, {
                persist: false
            });
